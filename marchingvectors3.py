...
verts=[[[0,7,3,4,1,6,2,5][v[i]] for i in (0,1)] for v in verts]#remmaped verts
lot2=[None]*256#remmaped lot
for i in range(256):
    key=0
    for ivec,shift in zip(range(8),[0,4,6,2,3,7,5,1]):
        parity=(i>>ivec)&1
        key|=parity<<shift
    lot2[i]=lot[key]
lot=lot2
...
#TODO remap verts#done
#TODO remap lot#done
#TODO reduce points
#TODO use strips
#TODO newton iterations to make points better
#TODO seperate negative points out
#TODO vectorize the voxel code
#TODO rewrite blademul
